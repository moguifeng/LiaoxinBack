...
import mp3 from '../mp3/classic.mp3';
import longMp3 from '../mp3/long.mp3';
...
class BasicLayout extends React.PureComponent {
  ...
  getPageTitle = (pathname, breadcrumbNameMap) => {
    ...
    return `${currRouterData.name} - ${window.title}`;
  };
...
export default connect(({ global, setting, menu, user, player }) => ({
