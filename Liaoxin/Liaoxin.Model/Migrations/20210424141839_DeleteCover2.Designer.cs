...
namespace Liaoxin.Model.Migrations
{
    ...
    [Migration("20210424141839_DeleteCover2")]
    partial class DeleteCover2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Liaoxin.Model.Bet", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.BetMode", b =>
                {
                    b.Property<int>("BetModeId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Liaoxin.Model.ChasingOrder", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.ChasingOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.DailyWage", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.DailyWageLog", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.DividendDate", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.DividendLog", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.DividendSetting", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.GiftEvent", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.GiftReceive", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.LotteryClassify", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.LotteryData", b =>
                {
                    b.Property<int>("LotteryDataId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Liaoxin.Model.LotteryOpenTime", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.LotteryPlayDetail", b =>
                {
                    b.Property<int>("LotteryPlayDetailId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Liaoxin.Model.LotteryPlayType", b =>
                {
                    b.Property<int>("LotteryPlayTypeId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Liaoxin.Model.LotteryType", b =>
                {
                    b.Property<int>("LotteryTypeId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Liaoxin.Model.Message", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.Platform", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.PlayerLotteryType", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.ProxyRegister", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.RebateLog", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.SoftwareExpired", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.Bet", b =>
                {
                    b.HasOne("Liaoxin.Model.BetMode", "BetMode")
                        .WithMany()
                        .HasForeignKey("BetModeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Liaoxin.Model.LotteryData", "LotteryData")
                        .WithMany()
                        .HasForeignKey("LotteryDataId");

                    b.HasOne("Liaoxin.Model.LotteryPlayDetail", "LotteryPlayDetail")
                        .WithMany()
            ...
            modelBuilder.Entity("Liaoxin.Model.ChasingOrderDetail", b =>
                {
                    b.HasOne("Liaoxin.Model.Bet", "Bet")
                        .WithMany()
                        .HasForeignKey("BetId");

                    b.HasOne("Liaoxin.Model.ChasingOrder", "ChasingOrder")
            ...
            modelBuilder.Entity("Liaoxin.Model.DividendLog", b =>
                {
                    b.HasOne("Liaoxin.Model.DividendDate", "DividendDate")
                        .WithMany()
            ...
            modelBuilder.Entity("Liaoxin.Model.LotteryData", b =>
                {
                    b.HasOne("Liaoxin.Model.LotteryType", "LotteryType")
                        .WithMany()
            ...
            modelBuilder.Entity("Liaoxin.Model.LotteryPlayDetail", b =>
                {
                    b.HasOne("Liaoxin.Model.LotteryPlayType", "LotteryPlayType")
            ...
            modelBuilder.Entity("Liaoxin.Model.LotteryType", b =>
                {
                    ...
                    b.HasOne("Liaoxin.Model.LotteryClassify", "LotteryClassify")
            ...
            modelBuilder.Entity("Liaoxin.Model.PlatformMoneyLog", b =>
                {
                    b.HasOne("Liaoxin.Model.Platform", "Platform")
                        .WithMany()
