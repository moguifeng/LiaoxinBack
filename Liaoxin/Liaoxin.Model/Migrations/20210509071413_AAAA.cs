    ...
    public partial class AAAA : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AffixId = table.Column<Guid>(nullable: false),
                    CreateTime = table.Column<DateTime>(nullable: false),
                    UpdateTime = table.Column<DateTime>(nullable: false),
                    IsEnable = table.Column<bool>(nullable: false),
                    Path = table.Column<string>(nullable: true),
                    NotAllowOtherSee = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateTime = table.Column<DateTime>(nullable: false),
                    IsEnable = table.Column<bool>(nullable: false),
                    Cover = table.Column<Guid>(nullable: true),
                    ...
                    UniqueFrontImg = table.Column<Guid>(nullable: true),
                    UniqueBackImg = table.Column<Guid>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEnable = table.Column<bool>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    BannerAffixId = table.Column<Guid>(nullable: false),
                    BankUserName = table.Column<string>(nullable: true),
                    Account = table.Column<string>(nullable: true),
                    ScanAffixId = table.Column<Guid>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundImg = table.Column<Guid>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(nullable: false),
                    LuckIndex = table.Column<int>(nullable: false),
                    LuckNumbers = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LuckNumber = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
