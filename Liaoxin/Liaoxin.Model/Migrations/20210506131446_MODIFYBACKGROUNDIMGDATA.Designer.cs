...
namespace Liaoxin.Model.Migrations
{
    ...
    [Migration("20210506131446_MODIFYBACKGROUNDIMGDATA")]
    partial class MODIFYBACKGROUNDIMGDATA
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Liaoxin.Model.Client", b =>
                {
                    ...
                    b.Property<int>("ErrorPasswordCount");
            ...
            modelBuilder.Entity("Liaoxin.Model.RateOfClient", b =>
                {
                    b.Property<Guid>("RateOfClientId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("RateOfClients");
                });

            modelBuilder.Entity("Liaoxin.Model.RateOfGroup", b =>
                {
                    b.Property<Guid>("RateOfGroupId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("RateOfGroups");
                });

            modelBuilder.Entity("Liaoxin.Model.RateOfGroupClient", b =>
                {
                    b.Property<Guid>("RateOfGroupClientId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Liaoxin.Model.RedPacket", b =>
                {
            ...
            modelBuilder.Entity("Liaoxin.Model.RedPacketReceive", b =>
                {
                    ...
                    b.Property<decimal>("SnatchMoney")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<DateTime>("UpdateTime");

                    b.HasKey("RedPacketReceiveId");
                    ...
                    b.HasIndex("RedPacketId");

                    b.HasIndex("UpdateTime");

                    b.ToTable("RedPacketReceives");
                });
            ...
            modelBuilder.Entity("Liaoxin.Model.RedPacketReceive", b =>
                {
                    ...
                    b.HasOne("Liaoxin.Model.RedPacket", "RedPacket")
                        .WithMany("RedPacketReceives")
                        .HasForeignKey("RedPacketId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
