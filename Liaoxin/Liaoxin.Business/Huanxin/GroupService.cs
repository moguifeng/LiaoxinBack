...
namespace Liaoxin.Business.Huanxin
{
    public class GroupService : BaseService, IGroupService
    {
        ...
        public void SetGroupManager(Guid clientId, Guid groupId, bool isExeSave = true)
        {
            ...
            GroupManager gm = Context.GroupManagers.FirstOrDefault(p => p.GroupId == groupId);
            if (gm != null)
            {
        ...
        public bool TransferGroupMaster(Guid newMasterClientId, Guid originalMasterClientId, Guid groupId)
        {
            ...
            if (g != null && g.ClientId == originalMasterClientId)
            {
                ...
                Context.SaveChanges();
                CancelGroupManager(originalMasterClientId, groupId);
                result = true;
            }
            return false;
        }
        ...
        public bool CreateGroup(Group entity)
        {
            ...
            AddGroupClient(entity.ClientId, entity.GroupId, true, false);
            Context.SaveChanges();
            result = true;
            return result;
        ...
        {
            return (from a in Context.GroupClients where a.GroupId == groupId && a.IsEnable select a.Client).Distinct().Where(p => p.IsEnable == isEnable).ToList();
        }
        /// <summary>
        /// 获取群
        /// </summary>
