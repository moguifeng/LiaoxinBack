...
{
    public class LotteryWinReport : BaseReport
    {
        public LotteryWinReport(int id) : base(id)
        {
        }
        ...
        protected override IQueryable<decimal> GetTodayData(List<int> list, LotteryContext context)
        {
            ...
            return from p in context.LotteryTypes where p.LotteryTypeId == Id && p.ReportDate == DateTime.Today select p.WinMoney;
        }
        ...
        protected override IQueryable<decimal> Sql(List<int> list, DateTime begin, DateTime end, LotteryContext context)
        {
            ...
            return from b in context.Bets
                   where b.LotteryPlayDetail.LotteryPlayType.LotteryTypeId == Id && b.UpdateTime >= begin && b.UpdateTime < end
